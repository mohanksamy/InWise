...
<title>InWise Verion 1.0 - Store Detail</title>
...
<%
	StoreDTO store = (StoreDTO) request.getAttribute("storeValue");
	pageContext.setAttribute("dto", store);
%>
...
<!--   					<a href ="stores"><input type="button" class="button" name="Cancel" value="Cancel" /></a> -->
			...
			<tr>
				<td class="mandatory"><label>Store Name:</label></td>
